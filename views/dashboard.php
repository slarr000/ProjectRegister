...
<head>
    ...
    <style>
        /* Дополнительные стили только для временной зоны */
        .timezone-badge {
            font-size: 0.7rem;
...
<body class="dashboard-body d-flex flex-column min-vh-100">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    ...
                    <div class="card dashboard-card border-0 shadow-lg fade-in">
                        <div class="card-body text-center p-4 p-md-5">
                            ...
                            <div class="mb-4">
                                ...
                                <h1 class="display-6 fw-bold text-primary mb-2">Добро пожаловать!</h1>
                                <p class="fw-bold fs-4 mb-4">
                                    <span class="text-dark username-highlight">
                                        <?= htmlspecialchars($_SESSION['username'] ?? 'Гость') ?>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-6">
                                    <div class="info-card p-3 rounded-3 border text-center">
                                        ...
                                        <small class="text-muted time-label">Сегодня</small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="info-card p-3 rounded-3 border text-center">
                                        ...
                                        <small class="text-muted time-label">Московское время</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                <a href="/logout" class="btn btn-danger btn-lg px-4 logout-btn" role="button">
    ...
    <script>
        ...
        // Обновляем время сразу при загрузке и каждую минуту
